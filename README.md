...
6) 2026_Mainz - ``MAGEMinApp`` introduction shortcourse in Mainz, Germany (Jan, 13, 2026)
    * Set of tutorials on how to install and use [``MAGEMinApp``](https://github.com/ComputationalThermodynamics/MAGEMinApp.jl)

    * Used versions: ``MAGEMin v1.8.5``, ``MAGEMin_C v2.1.0`` and ``MAGEMinApp v1.2.7``

5) 2025_Goldschmidt - ``MAGEMin``shortcourse at Goldschmidt conference in Prague, Czech republic (Jul 6, 2025)
...
4) 2025_IAVCEI - ``MAGEMin``shortcourse at IAVCEI conference in Geneva, Switzerland (Jul 5, 2025)
    * Installation guide for `MAGEMinApp` and `MAGEMin_C` using julia
